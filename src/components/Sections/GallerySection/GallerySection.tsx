        ...
        <div className={s.topBlock}>
          <div className={s.titleContainer}>
            <h2>
              ...
              <span>наші турботливі няні{line}</span>
            </h2>

            <p>
              Познайомтесь із нашими нянями через живі фото з роботи. Ми
              показуємо справжніх людей, які щодня дбають про дітей з теплом,
              професійністю та любовʼю
            </p>
