...
const cardsData = [
  {
    title: "Плануєте роботу за кордоном",
    description:
      "Підготуйтеся до нових умов, адаптуйте знання та стартуйте в іншій країні",
    icon: "/icons/course-icons.svg#icon-1",
  },
  {
    title: "Маєте практику і хочете рости",
    description:
      "Оновите знання, структуруєте досвід і отримаєте більше впевненості у роботі",
    icon: "/icons/course-icons.svg#icon-2",
  },
  {
    title: "Перші кроки в професії няні",
    description:
      "Опануйте базові знання, зрозумійте свою роль і отримайте підтримку",
    ...
    <section className={s.section}>
      ...
      <Container>
        <h2 className={s.title}>
          {svg}
          Цей курс<span> для вас{line} </span>
          якщо ви...
        </h2>
...
const line = (
  <svg viewBox="0 0 166 15" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
