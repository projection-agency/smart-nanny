  ...
  return (
    ...
    >
      <motion.path
        ...
        initial={length ? { strokeDashoffset: length } : false}
        animate={length ? { strokeDashoffset: 0 } : false}
        transition={length ? { duration: 1.2, ease: "easeOut" } : undefined}
      />
    </svg>
  );
};
