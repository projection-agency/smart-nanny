...
const contractSections = [
  {
    id: 1,
    question: "Загальні положення",
    answer:
      "Цей договір регулює відносини між замовником та виконавцем щодо надання послуг, визначених нижче.",
  },
  {
    id: 2,
    question: "Предмет договору",
    answer:
      "Предметом договору є надання виконавцем послуг, згідно з технічним завданням замовника.",
  },
  {
    id: 3,
    question: "Порядок надання послуг",
    answer:
      "Послуги надаються поетапно, згідно з погодженим графіком виконання робіт та термінами.",
  },
  {
    id: 4,
    question: "Права і обов'язки сторін",
    answer:
      "Замовник зобов'язується надати всю необхідну інформацію, виконавець — якісно та вчасно виконати роботи.",
  },
  {
    id: 5,
    question: "Вартість і порядок оплати",
    answer:
      "Вартість послуг узгоджується сторонами та сплачується поетапно або після завершення робіт, згідно з виставленим рахунком.",
  },
  {
    id: 6,
    question: "Гарантія і повернення коштів",
    answer:
      "Виконавець надає гарантію на виконані роботи протягом 30 днів. У разі виявлення недоліків — здійснюється доопрацювання або повернення коштів.",
  },
  {
    id: 7,
    question: "Конфіденційність та захист даних",
    answer:
      "Сторони зобов'язуються не передавати третім особам конфіденційну інформацію, отриману в процесі співпраці.",
  },
  {
    id: 8,
    question: "Відповідальність сторін",
    answer:
      "Сторони несуть відповідальність згідно з чинним законодавством та умовами цього договору.",
  },
  {
    id: 9,
    question: "Порядок вирішення спорів",
    answer:
      "Усі спори вирішуються шляхом переговорів, а у разі недосягнення згоди — у судовому порядку.",
  },
  {
    id: 10,
    question: "Строк дії договору",
    answer:
      "Договір набирає чинності з моменту підписання та діє до повного виконання зобов'язань сторонами.",
  },
];
  ...
  return (
    <main>
      <section className={s.section}>
        <h1>
          {svg}
          Договір <span>публічної оферти{line}</span>
        </h1>

        <ul className={s.list}>
          {contractSections.map((faq) => (
            <Accordion
              key={faq.id}
              id={faq.id}
