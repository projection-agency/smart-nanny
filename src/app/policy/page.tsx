...
const privacyPolicySections = [
  {
    ...
    question: "Хто ми",
    answer:
      "Ми — компанія, що надає цифрові послуги. Наші контактні дані вказані нижче.",
  },
  {
    id: 2,
    question: "Які персональні дані ми збираємо",
    answer:
      "Ми можемо збирати імʼя, email, номер телефону, IP-адресу та інші технічні дані.",
  },
  {
    id: 3,
    question: "Як ми використовуємо ваші дані",
    answer:
      "Ваші дані використовуються для надання послуг, комунікації та покращення сервісу.",
  },
  {
    id: 4,
    question: "Правові підстави для обробки даних",
    answer:
      "Ми обробляємо дані на підставі вашої згоди, виконання договору або законних інтересів.",
  },
  {
    id: 5,
    question: "Терміни зберігання даних",
    answer:
      "Дані зберігаються протягом часу, необхідного для досягнення мети обробки або згідно із законом.",
  },
  {
    id: 6,
    question: "Захист ваших даних",
    answer:
      "Ми використовуємо технічні та організаційні заходи для захисту ваших даних від несанкціонованого доступу.",
  },
  {
    id: 7,
    question: "Ваші права",
    answer:
      "Ви маєте право на доступ, зміну, видалення своїх даних та інші права відповідно до законодавства.",
  },
  {
    id: 8,
    question: "Зміни до Політики",
    answer:
      "Ми можемо час від часу оновлювати цю Політику. Усі зміни будуть публікуватися на цій сторінці.",
  },
  {
    id: 9,
    question: "Контакти",
    answer:
      "З усіх питань щодо конфіденційності ви можете звернутись до нас за email або телефоном, вказаними на сайті.",
  },
];
    ...
    <main>
      ...
      <section className={s.section}>
        <div className={s.titleContainer}>
          <h1>
            {svg}
            Політика <span>конфіденційності{line}</span>
          </h1>

          <span className={s.span}>
            Дата набуття чинності: 12 травня 2025 року
          </span>
          <p className={s.text}>
            Ми цінуємо вашу довіру та розуміємо, наскільки важливо забезпечити
            конфіденційність і безпеку ваших персональних даних. У цій Політиці
            конфіденційності пояснюється, які саме дані ми збираємо, як їх
            обробляємо, зберігаємо, кому передаємо, і які права маєте ви як
            користувач
          </p>
        </div>

        <ul className={s.list}>
          {privacyPolicySections.map((faq) => (
            <Accordion
              key={faq.id}
              id={faq.id}
